...
function App() {
  ...
  const timeButtonClass = sort === 'Sort By Time' ? "text-white bg-palette" : "text-palette";;
  const exhibitButtonClass = sort === 'Sort By Exhibit' ? "text-white bg-palette" : "text-palette";;
  const mapButtonClass = sort === 'Map View' ? "text-white bg-palette" : "text-palette";

  return (
    <>
      <div className={`font-poppins h-screen ${blurClass} ${overflowClass}`}>
